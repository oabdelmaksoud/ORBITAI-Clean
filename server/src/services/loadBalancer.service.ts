...
export class LoadBalancerService {
  ...
  async configure(_config: LoadBalancerConfig, _deployments: MultiCloudStatus[]): Promise<boolean> {
  ...
  async healthCheck(_deployments: MultiCloudStatus[]): Promise<MultiCloudStatus[]> {
  ...
  async routeTraffic(_deployments: MultiCloudStatus[], _strategy: string): Promise<MultiCloudStatus[]> {
