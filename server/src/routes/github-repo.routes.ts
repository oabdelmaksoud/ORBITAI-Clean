...
router.get('/repos', async (req, res) => {
  try {
    ...
    logger.error('List GitHub repos error:', error);
...
router.get('/repos/:owner/:repo', async (req, res) => {
  try {
    ...
    logger.error('Get GitHub repo error:', error);
...
router.get('/repos/:owner/:repo/contents', async (req, res) => {
  try {
    ...
    logger.error('Get contents error:', error);
...
router.put('/repos/:owner/:repo/contents/*', async (req, res) => {
  try {
    ...
    logger.error('Create/update file error:', error);
    res.status(500).json({
...
router.get('/repos/:owner/:repo/commits', async (req, res) => {
  try {
    ...
    logger.error('List commits error:', error);
