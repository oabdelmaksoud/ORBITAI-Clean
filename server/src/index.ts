...
app.use(
  cors({
    origin: (origin, callback) => {
      // Allow requests with no origin only in non-production (mobile apps, curl, Postman)
      // In production, null-origin requests are blocked to prevent CSRF from local files
      if (!origin) {
